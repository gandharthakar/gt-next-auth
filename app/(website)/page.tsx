	...
	return (
		<>
			<div className="flex flex-col items-center justify-center py-[100px] px-[20px] min-h-[calc(100vh-80px)] md:min-h-[calc(100vh-88px)]">
				...
				<div>
					<Link href={`/dashboard/${UserID.auth_user_id ? UserID.auth_user_id : '1'}`} title="Dashboard" className="inline-block transition-all delay-75 py-[10px] md:py-[15px] px-[20px] md:px-[25px] font-semibold text-[16px] md:text-[18px] bg-zinc-800 text-white rounded-lg hover:bg-blue-700">
						Dashboard
					</Link>
				</div>
			</div>
